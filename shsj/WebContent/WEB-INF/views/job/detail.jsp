    ...
    <div class="row">
    	<div class="col-md-10">
        	<div style="border:1px solid #DFDFDF;">
            	...
            	<div class="row">
            		<h5 style="margin:15px 0; text-indent:30px; font-weight:bolder;">${job.job.jTitle}</h5>
            		<table class="job-detail">
            			<tr>
            				<td style="width:10%;">招聘单位：</td>
            				<td style="width:90%;">${job.job.jOrganizer}</td>
            			</tr>
            		</table>
            	</div>
            	<div class="row">
            		...
            		<table class="job-detail">
            			<tr>
            				...
            				<td style="width:40%;">${job.jobBelong.jbName}(${job.jobType.jtName})</td>
            				<td style="width:10%;">工作区域：</td>
            				<td style="width:40%;">${job.job.jWorkPlace}</td>
            			</tr>
            			<tr>
            				<td style="width:10%;">工作待遇：</td>
            				<td style="width:40%;">${job.job.jSalary}${job.job.jSalaryType}</td>
            				<td style="width:10%;">工作时间：</td>
            				<td style="width:40%;">${job.job.jWorkTime}</td>
            			</tr>
            			<tr>
            				<td style="width:10%;">招聘人数：</td>
            				<td style="width:40%;">${job.job.jNumber}人</td>
            				<td style="width:10%;">人数限制：</td>
            				<td style="width:40%;">${job.job.jNumberLimit}人</td>
            			</tr>
            			<tr>
            				<td style="width:10%;">已报名：</td>
            				<td style="width:40%;">${job.job.jNumberReady}人</td>
            				<td style="width:10%;">结束时间：</td>
            				<td style="width:40%;">${fn:substring(job.job.jDatetimeEnd, 0, 10)}</td>
            			</tr>
            		</table>
            	</div>
            	<div class="row">
            		...
            		<table class="job-detail">
            			<tr>
            				...
            				<td style="width:40%;">${job.job.jContact}</td>
            				<td style="width:10%;">面试时间：</td>
            				<td style="width:40%;">${job.job.jAuditionTime}</td>
            			</tr>
            			<tr>
            				<td style="width:10%;">面试地址：</td>
            				<td style="width:90%;" colspan="3">${job.job.jAuditionPlace}</td>
            			</tr>
            		</table>
            	</div>
            	<div class="row">
