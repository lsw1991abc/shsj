...
<head>
	<title>${treasure.notice.n_title}</title>
</head>
  ...
  <div class="container">
    <div class="row">
    	<div class="col-md-10">
        	...
        	<h2 class="text-center" style="background:#F9F9F9; margin:0; min-height:40px; line-height:40px; word-break: break-word;">${treasure.notice.n_title}</h2>
            <p class="text-center" style="background:#F5F5F5; border:1px solid #E9E9E9; border-left:none; border-right:none; height:25px; line-height:25px; color:#333;">
            	作者:${treasure.notice.user_nickname}&nbsp;&nbsp;
            	点击:${treasure.noticeCount}次&nbsp;&nbsp;
            	发布时间:${fn:substring(treasure.notice.n_datetime_build, 0, 19)}</p>
            <div class="lead treasure_content" style="padding:15px 20px;">
            	${treasure.notice.n_desc}
            </div>
            <style type="text/css">
