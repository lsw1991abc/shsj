	...
	<div class="row-fluid" style="margin-bottom: 10px;">
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group" role="group">
				<button type="button" class="btn btn-primary" onclick="location.href='<%=adminPath %>/baodian/'">
					<i class="fa fa-user-plus"></i>返回宝典列表
				</button>
			</div>
		</div>
	</div>
	<div class="row-fluid">
      ...
      <div class="panel-body">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="treasure-title" name="title" placeholder="标题长度1～50"
		  ...
		  <div class="form-group">
		    ...
		    <textarea class="form-control" rows="3" style="resize:vertical;" id="treasure-content" name="content"></textarea>
		  </div>
		...
		<script type="text/javascript">
			$(function() {
				CKEDITOR.replace('treasure-content', {
