...
<script type="text/javascript">
	...
	$('#sidebar-nav #users-menu #users-add').addClass("active");
</script>
<div class="header">
...
<ol class="breadcrumb">
	...
	<li><a href="<%=adminPath %>/user/">用户管理</a></li>
...
<div class="container-fluid">
	<div class="row-fluid" style="margin-bottom: 10px;">
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group" role="group">
				<button type="button" class="btn btn-primary" onclick="location.href='<%=adminPath %>/user/'">
					<i class="fa fa-user-plus"></i>返回用户列表
				</button>
			</div>
		</div>
	</div>
	<div class="row-fluid">
      ...
      <div class="panel-body">
       	<form role="form" action="<%=adminPath %>/user/save" method="post" id="user-form">
       	
		  <div class="form-group">
		    <label for="notice-title">标题</label>
		    <input type="text" class="form-control" id="user-account" name="account" placeholder="用户名长度6～32"
