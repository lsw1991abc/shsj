...
<head>
	<title>${notice.notice.n_title}</title>
  ...
  <div class="container">
    <div class="row">
    	<div class="col-md-10">
        	...
        	<h2 class="text-center" style="background:#F9F9F9; margin:0; height:40px; line-height:40px;">${notice.notice.n_title}</h2>
            <p class="text-center" style="background:#F5F5F5; border:1px solid #E9E9E9; border-left:none; border-right:none; height:25px; line-height:25px; color:#333;">
            	作者:${notice.notice.user_nickname}&nbsp;&nbsp;
            	点击:${notice.noticeCount}次&nbsp;&nbsp;
            	发布时间:${fn:substring(notice.notice.n_datetime_build, 0, 19)}</p>
            <div class="lead notice_content" style="padding:15px 20px;">
            	${notice.notice.n_desc}
            </div>
          </div>
        </div>
        <div class="col-md-2">
