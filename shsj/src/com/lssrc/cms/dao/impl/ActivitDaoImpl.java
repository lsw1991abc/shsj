...
public class ActivitDaoImpl extends BaseDao implements ActivitDao {
	...
	//select as_name,a_id,a_title,a_desc,a_organizer,a_plotter,a_number,a_datetime_start,a_datetime_end,a_statu,a_datetime_build,a_builder,a_pic,a_hot 
	//from shsj_activit, shsj_activit_statu 
	//where shsj_activit.a_statu=shsj_activit_statu.as_id
